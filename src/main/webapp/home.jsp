    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content form-container">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-custom">Salvar</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid d-flex flex-column vh-100 p-0">
            ...
            <div class="offcanvas-body">
                <div class="mt-3">
                    <ul class="list-unstyled">
                        <li><button class="btn btn-primary menu-btn px-5 text-white" data-bs-toggle="modal" data-bs-target="#produtoModal">Novo Registro</button></li>
    ...
    <div class="conteudo-container d-flex flex-column align-items-center text-center">
        <div class="conteudo-header">
            <h4 class="mt-4">Saldo</h4>
            <h4 class="valor-economizado mt-3">R$: ****</h4>
        ...
        <div class="container-fluid">
            <div class="table-responsive rounded">
                <table>
                    ...
                    <tr>
                        <td class="p-2">1</td>
                        <td class="p-2">essae</td>
                        <td class="p-2">100 reais</td>
                    </tr>
                    <tr>
                        <td class="p-2">2</td>
                        <td class="p-2">outro</td>
                        <td class="p-2">200 reais</td>
                    </tr>
                    <tr>
                        <td class="p-2">3</td>
                        <td class="p-2">item</td>
                        <td class="p-2">300 reais</td>
                    </tr>
